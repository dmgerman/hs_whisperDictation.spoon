...
- Warning notification: "🛑 Recording auto-stopped due to timeout"
...
- *Console*: Hammerspoon menu → Console (real-time)
...
- *Auto-start*: Server starts when spoon starts
