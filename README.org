...
It records audio from your microphone, transcribes it using =whisperkit-cli=, and automatically copies the transcribed text to your clipboard. Processing is done asynchronously, allowing you to continue working while transcription happens in the background. A menubar indicator shows recording status and elapsed time.
